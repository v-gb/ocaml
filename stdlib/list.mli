...
val compare_length_with : list('a) -> int -> int
...
val equal : ('a -> 'a -> bool) -> list('a) -> list('a) -> bool
...
val compare : ('a -> 'a -> int) -> list('a) -> list('a) -> int
...
val fold_left : ('acc -> 'a -> 'acc) -> 'acc -> list('a) -> 'acc
(** [fold_left f init [b1; ...; bn]] is
   [f (... (f (f init b1) b2) ...) bn].
 *)

val fold_right : ('a -> 'acc -> 'acc) -> list('a) -> 'acc -> 'acc
...
val rev_map2 : ('a -> 'b -> 'c) -> list('a) -> list('b) -> list('c)
...
val for_all2 : ('a -> 'b -> bool) -> list('a) -> list('b) -> bool
(** Same as {!for_all}, but for a two-argument predicate.
   @raise Invalid_argument if the two lists are determined
   to have different lengths.
 *)

val exists2 : ('a -> 'b -> bool) -> list('a) -> list('b) -> bool
...
val find_index : ('a -> bool) -> list('a) -> option(int)
...
val find_map : ('a -> option('b)) -> list('a) -> option('b)
...
val find_mapi : (int -> 'a -> option('b)) -> list('a) -> option('b)
...
val find_all : ('a -> bool) -> list('a) -> list('a)
(** [find_all] is another name for {!filter}.
 *)

val filteri : (int -> 'a -> bool) -> list('a) -> list('a)
...
val take_while : ('a -> bool) -> list('a) -> list('a)
...
val drop_while : ('a -> bool) -> list('a) -> list('a)
...
val partition_map : ('a -> Either.t('b, 'c)) -> list('a) -> list('b) * list('c)
...
val stable_sort : ('a -> 'a -> int) -> list('a) -> list('a)
