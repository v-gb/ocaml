...
val compare_lengths : list('a) -> list('b) -> int
...
val compare_length_with : list('a) -> len:int -> int
...
val nth_opt : list('a) -> int -> option('a)
(** Return the [n]-th element of the given list.
    The first element (head of the list) is at position 0.
...
val init : len:int -> f:(int -> 'a) -> list('a)
...
val rev_append : list('a) -> list('a) -> list('a)
...
val equal : eq:('a -> 'a -> bool) -> list('a) -> list('a) -> bool
...
val compare : cmp:('a -> 'a -> int) -> list('a) -> list('a) -> int
...
val iter : f:('a -> unit) -> list('a) -> unit
(** [iter ~f [a1; ...; an]] applies function [f] in turn to
   [[a1; ...; an]]. It is equivalent to
   [f a1; f a2; ...; f an].
 *)

val iteri : f:(int -> 'a -> unit) -> list('a) -> unit
...
val mapi : f:(int -> 'a -> 'b) -> list('a) -> list('b)
...
val rev_map : f:('a -> 'b) -> list('a) -> list('b)
(** [rev_map ~f l] gives the same result as
   {!rev}[ (]{!map}[ f l)], but is more efficient.
 *)

val filter_map : f:('a -> option('b)) -> list('a) -> list('b)
...
val concat_map : f:('a -> list('b)) -> list('a) -> list('b)
...
val fold_left_map :
  f:('acc -> 'a -> 'acc * 'b) -> init:'acc -> list('a) -> 'acc * list('b)
(** [fold_left_map] is  a combination of [fold_left] and [map] that threads an
    accumulator through calls to [f].
    @since 4.11
*)

val fold_left : f:('acc -> 'a -> 'acc) -> init:'acc -> list('a) -> 'acc
(** [fold_left ~f ~init [b1; ...; bn]] is
   [f (... (f (f init b1) b2) ...) bn].
 *)

val fold_right : f:('a -> 'acc -> 'acc) -> list('a) -> init:'acc -> 'acc
...
val iter2 : f:('a -> 'b -> unit) -> list('a) -> list('b) -> unit
...
val map2 : f:('a -> 'b -> 'c) -> list('a) -> list('b) -> list('c)
...
val rev_map2 : f:('a -> 'b -> 'c) -> list('a) -> list('b) -> list('c)
(** [rev_map2 ~f l1 l2] gives the same result as
   {!rev}[ (]{!map2}[ f l1 l2)], but is more efficient.
 *)

val fold_left2 :
  f:('acc -> 'a -> 'b -> 'acc) -> init:'acc -> list('a) -> list('b) -> 'acc
...
val fold_right2 :
  f:('a -> 'b -> 'acc -> 'acc) -> list('a) -> list('b) -> init:'acc -> 'acc
...
val for_all : f:('a -> bool) -> list('a) -> bool
...
val exists : f:('a -> bool) -> list('a) -> bool
...
val for_all2 : f:('a -> 'b -> bool) -> list('a) -> list('b) -> bool
(** Same as {!for_all}, but for a two-argument predicate.
   @raise Invalid_argument if the two lists are determined
   to have different lengths.
 *)

val exists2 : f:('a -> 'b -> bool) -> list('a) -> list('b) -> bool
(** Same as {!exists}, but for a two-argument predicate.
   @raise Invalid_argument if the two lists are determined
   to have different lengths.
 *)

val mem : 'a -> set:list('a) -> bool
(** [mem a ~set] is true if and only if [a] is equal
   to an element of [set].
 *)

val memq : 'a -> set:list('a) -> bool
...
val find_opt : f:('a -> bool) -> list('a) -> option('a)
(** [find ~f l] returns the first element of the list [l]
   that satisfies the predicate [f].
...
val find_index : f:('a -> bool) -> list('a) -> option(int)
...
val find_map : f:('a -> option('b)) -> list('a) -> option('b)
...
val find_mapi : f:(int -> 'a -> option('b)) -> list('a) -> option('b)
...
val take_while : f:('a -> bool) -> list('a) -> list('a)
...
val drop_while : f:('a -> bool) -> list('a) -> list('a)
...
val partition : f:('a -> bool) -> list('a) -> list('a) * list('a)
...
val partition_map : f:('a -> Either.t('b, 'c)) -> list('a) -> list('b) * list('c)
...
val assoc_opt : 'a -> list('a * 'b) -> option('b)
...
val sort : cmp:('a -> 'a -> int) -> list('a) -> list('a)
...
val stable_sort : cmp:('a -> 'a -> int) -> list('a) -> list('a)
...
val fast_sort : cmp:('a -> 'a -> int) -> list('a) -> list('a)
(** Same as {!sort} or {!stable_sort}, whichever is
    faster on typical input.
 *)

val sort_uniq : cmp:('a -> 'a -> int) -> list('a) -> list('a)
(** Same as {!sort}, but also remove duplicates.
    @since 4.02 (4.03 in ListLabels)
 *)

val merge : cmp:('a -> 'a -> int) -> list('a) -> list('a) -> list('a)
(** Merge two lists:
...
val to_seq : list('a) -> Seq.t('a)
(** Iterate on the list.
    @since 4.07
 *)

val of_seq : Seq.t('a) -> list('a)
