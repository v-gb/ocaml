...
val make_matrix : int -> int -> 'a -> array(array('a))
...
val init_matrix : int -> int -> (int -> int -> 'a) -> array(array('a))
...
val sub : array('a) -> int -> int -> array('a)
...
val fill : array('a) -> int -> int -> 'a -> unit
...
val equal : ('a -> 'a -> bool) -> array('a) -> array('a) -> bool
...
val compare : ('a -> 'a -> int) -> array('a) -> array('a) -> int
...
val iter2 : ('a -> 'b -> unit) -> array('a) -> array('b) -> unit
...
val map2 : ('a -> 'b -> 'c) -> array('a) -> array('b) -> array('c)
...
val find_index : ('a -> bool) -> array('a) -> option(int)
...
val find_map : ('a -> option('b)) -> array('a) -> option('b)
(** [find_map f a] applies [f] to the elements of [a] in order, and returns the
    first result of the form [Some v], or [None] if none exist.

    @since 4.13 *)

val find_mapi : (int -> 'a -> option('b)) -> array('a) -> option('b)
...
val stable_sort : ('a -> 'a -> int) -> array('a) -> unit
...
val fast_sort : ('a -> 'a -> int) -> array('a) -> unit
