...
type kind('a, 'b) =
  ...
  | Float16 : kind(float, float16_elt)  (**)
...
val float16 : kind(float, float16_elt)
(** See {!Bigarray.char}.
   @since 5.2 *)

val float32 : kind(float, float32_elt)
(** See {!Bigarray.char}. *)

val float64 : kind(float, float64_elt)
(** See {!Bigarray.char}. *)

val complex32 : kind(Complex.t, complex32_elt)
(** See {!Bigarray.char}. *)

val complex64 : kind(Complex.t, complex64_elt)
(** See {!Bigarray.char}. *)

val int8_signed : kind(int, int8_signed_elt)
(** See {!Bigarray.char}. *)

val int8_unsigned : kind(int, int8_unsigned_elt)
(** See {!Bigarray.char}. *)

val int16_signed : kind(int, int16_signed_elt)
(** See {!Bigarray.char}. *)

val int16_unsigned : kind(int, int16_unsigned_elt)
(** See {!Bigarray.char}. *)

val int : kind(int, int_elt)
...
val int32 : kind(int32, int32_elt)
(** See {!Bigarray.char}. *)

val int64 : kind(int64, int64_elt)
(** See {!Bigarray.char}. *)

val nativeint : kind(nativeint, nativeint_elt)
(** See {!Bigarray.char}. *)

val char : kind(char, int8_unsigned_elt)
...
val kind_size_in_bytes : kind('a, 'b) -> int
...
val c_layout : layout(c_layout)
val fortran_layout : layout(fortran_layout)
...
module Genarray :
  ...
  external create: kind('a, 'b) -> layout('c) -> array(int) -> t('a, 'b, 'c)
    = "caml_ba_create"
  ...
  val init: kind('a, 'b) -> layout('c) -> array(int) -> (array(int) -> 'a) ->
            t('a, 'b, 'c)
  ...
  external kind: t('a, 'b, 'c) -> kind('a, 'b) = "caml_ba_kind"
  (** Return the kind of the given Bigarray. *)

  external layout: t('a, 'b, 'c) -> layout('c) = "caml_ba_layout"
  (** Return the layout of the given Bigarray. *)

  external change_layout: t('a, 'b, 'c) -> layout('d) -> t('a, 'b, 'd)
  ...
  *)
  ...
  external set: t('a, 'b, 'c) -> array(int) -> 'a -> unit
    = "caml_ba_set_generic"
  ...
  external sub_left: t('a, 'b, c_layout) -> int -> int -> t('a, 'b, c_layout)
    = "caml_ba_sub"
  ...
  external sub_right:
    t('a, 'b, fortran_layout) -> int -> int -> t('a, 'b, fortran_layout)
    = "caml_ba_sub"
  (** Extract a sub-array of the given Bigarray by restricting the
  ...
  external slice_left:
    t('a, 'b, c_layout) -> array(int) -> t('a, 'b, c_layout)
    = "caml_ba_slice"
  ...
  external slice_right:
    t('a, 'b, fortran_layout) -> array(int) -> t('a, 'b, fortran_layout)
    = "caml_ba_slice"
  (** Extract a sub-array of lower dimension from the given Bigarray
  ...
  external blit: t('a, 'b, 'c) -> t('a, 'b, 'c) -> unit
      = "caml_ba_blit"
  ...
  external fill: t('a, 'b, 'c) -> 'a -> unit = "caml_ba_fill"
...
module Array0 : sig
  ...
  val create: kind('a, 'b) -> layout('c) -> t('a, 'b, 'c)
  ...
  val init: kind('a, 'b) -> layout('c) -> 'a -> t('a, 'b, 'c)
  ...
  val change_layout: t('a, 'b, 'c) -> layout('d) -> t('a, 'b, 'd)
  ...
  *)
  ...
  val set: t('a, 'b, 'c) -> 'a -> unit
  (** [Array0.set a x v] stores the value [v] in [a]. *)

  external blit: t('a, 'b, 'c) -> t('a, 'b, 'c) -> unit = "caml_ba_blit"
  ...
  val of_value: kind('a, 'b) -> layout('c) -> 'a -> t('a, 'b, 'c)
...
module Array1 : sig
  ...
  val create: kind('a, 'b) -> layout('c) -> int -> t('a, 'b, 'c)
  ...
  val init: kind('a, 'b) -> layout('c) -> int -> (int -> 'a) ->
            t('a, 'b, 'c)
  ...
  external dim: t('a, 'b, 'c) -> int = "%caml_ba_dim_1"
  ...
  *)
  ...
  external get: t('a, 'b, 'c) -> int -> 'a = "%caml_ba_ref_1"
  ...
  external set: t('a, 'b, 'c) -> int -> 'a -> unit = "%caml_ba_set_1"
  ...
  val of_array: kind('a, 'b) -> layout('c) -> array('a) -> t('a, 'b, 'c)
  (** Build a one-dimensional Bigarray initialized from the
     given array.  *)

  external unsafe_get: t('a, 'b, 'c) -> int -> 'a = "%caml_ba_unsafe_ref_1"
  (** Like {!Bigarray.Array1.get}, but bounds checking is not always performed.
      Use with caution and only when the program logic guarantees that
      the access is within bounds. *)

  external unsafe_set: t('a, 'b, 'c) -> int -> 'a -> unit
...
module Array2 :
  ...
  val create: kind('a, 'b) ->  layout('c) -> int -> int -> t('a, 'b, 'c)
  ...
  val init: kind('a, 'b) ->  layout('c) -> int -> int ->
            (int -> int -> 'a) -> t('a, 'b, 'c)
  ...
  external dim1: t('a, 'b, 'c) -> int = "%caml_ba_dim_1"
  (** Return the first dimension of the given two-dimensional Bigarray. *)

  external dim2: t('a, 'b, 'c) -> int = "%caml_ba_dim_2"
  ...
  *)
  ...
  external get: t('a, 'b, 'c) -> int -> int -> 'a = "%caml_ba_ref_2"
  ...
  external set: t('a, 'b, 'c) -> int -> int -> 'a -> unit = "%caml_ba_set_2"
  ...
  val slice_left: t('a, 'b, c_layout) -> int -> Array1.t('a, 'b, c_layout)
  ...
  val slice_right:
    t('a, 'b, fortran_layout) -> int -> Array1.t('a, 'b, fortran_layout)
...
module Array3 :
  ...
  val create: kind('a, 'b) -> layout('c) -> int -> int -> int -> t('a, 'b, 'c)
  ...
  val init: kind('a, 'b) ->  layout('c) -> int -> int -> int ->
            (int -> int -> int -> 'a) -> t('a, 'b, 'c)
  ...
  external dim3: t('a, 'b, 'c) -> int = "%caml_ba_dim_3"
  ...
  *)
  ...
  external get: t('a, 'b, 'c) -> int -> int -> int -> 'a = "%caml_ba_ref_3"
  ...
  external set: t('a, 'b, 'c) -> int -> int -> int -> 'a -> unit
    = "%caml_ba_set_3"
  ...
  val slice_left_1:
    t('a, 'b, c_layout) -> int -> int -> Array1.t('a, 'b, c_layout)
  ...
  val slice_right_1:
    t('a, 'b, fortran_layout) ->
    int -> int -> Array1.t('a, 'b, fortran_layout)
  (** Extract a one-dimensional slice of the given three-dimensional
  ...
  val slice_left_2: t('a, 'b, c_layout) -> int -> Array2.t('a, 'b, c_layout)
  ...
  val slice_right_2:
    t('a, 'b, fortran_layout) -> int -> Array2.t('a, 'b, fortran_layout)
...
val reshape : Genarray.t('a, 'b, 'c) -> array(int) -> Genarray.t('a, 'b, 'c)
...
val reshape_0 : Genarray.t('a, 'b, 'c) -> Array0.t('a, 'b, 'c)
(** Specialized version of {!Bigarray.reshape} for reshaping to
   zero-dimensional arrays.
   @since 4.05 *)

val reshape_1 : Genarray.t('a, 'b, 'c) -> int -> Array1.t('a, 'b, 'c)
(** Specialized version of {!Bigarray.reshape} for reshaping to
   one-dimensional arrays. *)

val reshape_2 : Genarray.t('a, 'b, 'c) -> int -> int -> Array2.t('a, 'b, 'c)
(** Specialized version of {!Bigarray.reshape} for reshaping to
