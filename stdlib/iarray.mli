...
val append : iarray('a) -> iarray('a) -> iarray('a)
...
val concat : list(iarray('a)) -> iarray('a)
(** Same as {!append}, but concatenates a list of immutable arrays. *)

val sub : iarray('a) -> pos:int -> len:int -> iarray('a)
...
val to_list : iarray('a) -> list('a)
(** [to_list a] returns the list of all the elements of [a]. *)

val of_list : list('a) -> iarray('a)
...
val equal : ('a -> 'a -> bool) -> iarray('a) -> iarray('a) -> bool
...
val compare : ('a -> 'a -> int) -> iarray('a) -> iarray('a) -> int
...
val iter2 : ('a -> 'b -> unit) -> iarray('a) -> iarray('b) -> unit
...
val map2 : ('a -> 'b -> 'c) -> iarray('a) -> iarray('b) -> iarray('c)
...
val find_index : ('a -> bool) -> iarray('a) -> option(int)
...
val find_map : ('a -> option('b)) -> iarray('a) -> option('b)
(** [find_map f a] applies [f] to the elements of [a] in order, and returns the
    first result of the form [Some v], or [None] if none exist. *)

val find_mapi : (int -> 'a -> option('b)) -> iarray('a) -> option('b)
...
val split : iarray('a * 'b) -> iarray('a) * iarray('b)
(** [split [|(a1,b1); ...; (an,bn)|]] is
    [([|a1; ...; an|], [|b1; ...; bn|])]. *)

val combine : iarray('a) -> iarray('b) -> iarray('a * 'b)
...
val sort : ('a -> 'a -> int) -> iarray('a) -> iarray('a)
...
val stable_sort : ('a -> 'a -> int) -> iarray('a) -> iarray('a)
